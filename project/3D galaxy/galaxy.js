...
//   // ====== Galaxy Creation ======
//   let galaxy;
//   function createGalaxy(innerColor = "#00ffff", outerColor = "#ff3399") {
...
//       const randomX = Math.pow(Math.random(), params.randomnessPower) *
//         (Math.random() < 0.5 ? 1 : -1) * params.randomness * radius;
//       const randomY = Math.pow(Math.random(), params.randomnessPower) *
//         (Math.random() < 0.5 ? 1 : -1) * params.randomness * radius;
//       const randomZ = Math.pow(Math.random(), params.randomnessPower) *
//         (Math.random() < 0.5 ? 1 : -1) * params.randomness * radius;
...
//     if (galaxy) galaxy.rotation.y += 0.001 * speedMultiplier;
//     controls.update();
...
//     createGalaxy("#ff3399", "#00ffff");
//     const stats = document.getElementById('stats');
//     stats.innerHTML = "<div>Systems: Engaged</div><div>Resonance: Active</div><div>Phase: Harmonized</div>";
//   });

//   document.getElementById('time-accel').addEventListener('click', (e) => {
//     if (speedMultiplier === 1) {
//       speedMultiplier = 3;
//       e.target.querySelector('span:last-child').textContent = "Time: 3x";
//     } else {
//       speedMultiplier = 1;
//       e.target.querySelector('span:last-child').textContent = "Time: 1x";
//     }
//   });

//   document.getElementById('toggle-theme').addEventListener('click', (e) => {
//     if (theme === 'inferno') {
//       document.body.style.background = 'radial-gradient(circle, #001010 0%, #000 100%)';
//       createGalaxy("#00ffff", "#ff99cc");
//       e.target.querySelector('span:last-child').textContent = "Theme: Nebula";
//       theme = 'nebula';
//     } else {
//       document.body.style.background = 'radial-gradient(circle, #100000 0%, #000 100%)';
//       createGalaxy("#ff6600", "#ff0066");
//       e.target.querySelector('span:last-child').textContent = "Theme: Inferno";
//       theme = 'inferno';
//     }
//   });
